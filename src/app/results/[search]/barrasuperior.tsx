...
const TopBar: React.FC = () => {
    return (
            <div className="flex justify-around content-center mb-8 ml-32  ">
                <div className="flex border-2 shadow-md shadow-slate-400 border-light-blue rounded-lg overflow-hidden">
