...
const CreateAddressLocal: React.FC = () => {
    ...
    const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!validation.success) {
            const errors = validation.error.formErrors.fieldErrors as Record<string, string[]>;
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/update-address-local/${placeId}/`, {
                method: 'PUT',
                headers: {
            ...
            <div className="flex h-full scale-90">
                ...
                <div className="w-5/12 bg-white pt-0 pl-1 shadow-lg rounded-lg flex flex-col justify-between">
                    ...
                    <div className="border border-gray-300 p-1 rounded-lg flex flex-col justify-between h-full">
                        ...
                        <div className="mx-auto w-3/4 ">
                            <p className="text-gray-800 mt-2">{fullAddress || 'Localização'}</p>
